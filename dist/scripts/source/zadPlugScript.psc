...
string strFailEquipHeavyBondage = "Try as you might, your bound hands prevent you from inserting this plug."
...
int Function OnEquippedFilter(actor akActor, bool silent=false)
	...
	If akActor.WornHasKeyword(libs.zad_DeviousHeavyBondage)
		libs.NotifyActor(strFailEquipHeavyBondage, akActor, true)
		if !silent
			return 2
		Else
			return 0
...
Function RemovePlugNoLock()
	If libs.PlayerRef.WornHasKeyword(libs.zad_DeviousHeavyBondage)
		NoKeyFailMessageHeavyBondage(libs.PlayerRef)
		Return
	EndIf
	If libs.Playerref.WornHasKeyword(libs.zad_DeviousBelt) && !(deviceRendered.HasKeyword(libs.zad_DeviousPlugAnal) && libs.PlayerRef.WornHasKeyword(libs.zad_permitAnal))			
...
Function NoKeyFailMessageHeavyBondage(Actor akActor)
	if akActor == libs.PlayerRef
		libs.NotifyPlayer("Try as you might, your bound hands prevent you from removing this plug.", true)
	EndIf
EndFunction
